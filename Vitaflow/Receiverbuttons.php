...
<!-- Receiver Button Content Section -->
<div class="content">
    <h1>Welcome, Receiver!</h1>
    <p>Ready to receive support? Choose an option below to get started.</p>

    <!-- Sign In and Sign Up Buttons -->
    <a href="<?php echo $baseUrl; ?>/Receiverlogin.php" class="cta-button">Sign In</a>
    <a href="<?php echo $baseUrl; ?>/ReceiverRegis.php" class="cta-button">Sign Up</a>
</div>
