...
<!-- Content Section for Donor -->
<div class="content">
    <h1>Welcome, Donor!</h1>
    <p>Ready to make a difference? Choose an option below to get started.</p>

    <!-- Sign In and Sign Up Buttons -->
    <a href="<?php echo $baseUrl; ?>/Donorlogin.php" class="cta-button">Sign In</a>
    <a href="<?php echo $baseUrl; ?>/DonorRegis.php" class="cta-button">Sign Up</a>
</div>
